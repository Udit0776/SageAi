...
import { FileText, GraduationCap, LayoutDashboard, PenBox, ChevronDown, Target, Brain, Globe } from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuGroup,
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuGroup>
                                        ...
                                        <DropdownMenuItem asChild className="cursor-pointer">
                                            <Link href="/portfolio" className="flex w-full items-center gap-2">
                                                <Globe className="h-4 w-4" />
                                                <span>AI Portfolio Builder</span>
                                            </Link>
                                        </DropdownMenuItem>
                                        <DropdownMenuItem asChild className="cursor-pointer">
                                            <Link href="/ai-tailor" className="flex w-full items-center gap-2">
                                        ...
                                        <DropdownMenuItem asChild className="cursor-pointer">
                                            <Link href="/interview/coach" className="flex w-full items-center gap-2">
