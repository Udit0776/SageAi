...
import {
  generateCompanyBattlePlan,
  deleteCompanyBattlePlan,
} from "@/action/company-intel";
...
export default function BattlePlanGenerator({ pastPlans: initialPlans }) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const promise = generateCompanyBattlePlan(
        companyName.trim(),
    ...
    <div className="space-y-8">
      ...
      <Card className="bg-card/50 backdrop-blur-sm border-primary/10 shadow-xl">
        <CardHeader className="bg-primary/5 border-b border-primary/10">
          ...
          <CardDescription>
            Enter a company name and we'll create a comprehensive interview prep
            cheat sheet.
          </CardDescription>
        </CardHeader>
                ...
                <CardContent className="p-0">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-bold">
                          {plan.companyName || "Unknown Company"}
                        </div>
                  ...
                  {expandedPlanId === plan.id && (
                    <div className="border-t p-4 animate-in fade-in slide-in-from-top-2 duration-300">
                      {(() => {
                        try {
                          if (!plan.content || plan.content === "undefined")
                          ...
                          return (
                            <BattlePlanView
                              ...
                              companyName={plan.companyName || "this company"}
                            />
                          );
                        } catch (err) {
                          return (
                            <div className="text-sm text-destructive p-4 text-center bg-destructive/5 rounded-lg border border-destructive/10">
                              ...
                              <p className="text-[10px] opacity-70">
                                The AI response for this plan was malformed.
                                Please try deleting and regenerating it.
                              </p>
                            </div>
                          );
                        }
