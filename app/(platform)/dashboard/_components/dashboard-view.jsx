...
import CareerHealthWidget from './career-health-widget';
import StreakTrophyShelf from './streak-trophy-shelf';
...
export default function DashboardView({ insights, interviewSessions, jobApplications, stats, latestHealthScore, healthHistory, streak }) {
    ...
    <div className="space-y-6 pb-10">
      ...
      <Tabs defaultValue="insights" className="w-full">
        ...
        <TabsContent value="insights" className="space-y-6">
          {/* 1. Personal Progress Row */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch my-2">
            <CareerHealthWidget latestScore={latestHealthScore} history={healthHistory} />
            <StreakTrophyShelf streak={streak} />
          </div>

          {/* 2. Market Insights Grid */}
